...
Moreover, the Duncan Test performed compared to the authors’ varied because some factors. First, in some variables like plant height, biomass distribution, and yield there were some problems in the article tables with the letters of the groups. For example, in the variable plant height in the year 2015, the letters are changed. The lowest values are with letter “a” and the higher with “b” but in the other data the letter are in the other way around. Another factor that affected was that in the variables disease incidence and disease severity, the author grouped the highest values with “c”, unlike us that “c” was the lowest values. Also in colony diameter variable, the author's analysis differ to us becuase they use p values different of 0.05.
