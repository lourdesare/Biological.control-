...
```{r,fig.cap="Figure No 3. Normality of Residuals Plant Height"}
...
```{r,fig.cap="Figure No. 6 Normality of Residuals Disease Incidence"}
...
```{r,fig.cap="Figure No. 9 Normality of Residuals Disease Incidence"}
...
```{r,fig.cap="Figure No. 12 Normality of Residuals Stems"}
#Residuals Stems
...
```{r,fig.cap="Figure No. 15 Normality of Residuals Percentage of Biomass"}
#Residuals Biomass
...
```{r,fig.cap="Figure No. 18 Normality of Residuals Yield of Potato"}
#Graph 
...
```{r,fig.cap="Figure No. 22 Normality of Residuals for Antagonistic activity"}
#Graph 
par(mfrow = c(2, 2), oma = c(0, 0, 1.1, 0))
