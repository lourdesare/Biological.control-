...
We can see only few differences between the results of Ducan, Tukey and Kruskal test, in the differences between treatments (Figures 1, 2 and 3). Also, the Shapiro-Wilk normality test was performed for Anova and Square Root Anova because in Anova p was almost higher than 0.05, that means that the data is really similar to a normal distribution (Figure 4) and, in this case, the best test to be used would be the Tukey test because of the normal distribution of the results.
...
We can see only few differences between the results of Ducan, Tukey and Kruskal test, in the differences between treatments (Figures 5, 6 and 7). Also, The Shapiro-Wilk normality test was performed for Anova and Square Root Anova because in Anova p was almost higher than 0.05 (in the Anova, with the normal values), what means that the data is really similar to a normal distribution (Figure 8) and, in this case the best test to be used would be the Tukey test because of the normal distribution of the results.
...
We can see only few differences between the results of Ducan, Tukey and Kruskal test, in the differences between treatments (Figures 13, 14 and 15). The Shapiro-Wilk normality test was performed for Anova and Square Root Anova because in Anova p was lower than 0.05, that means that the data don't deviate from a normal distribution (Figure 16) and, in this case, the best test to be used is a nonparametric test, like the Ducan or Kruskal, to compare the differences between the treatments.
...
We can't see differences between the results of Ducan, Tukey and Kruskal test, in the differences between treatments (Figures 17, 18 and 19). The Shapiro-Wilk normality test was performed for Anova and Square Root Anova because in Anova p was higher than 0.05, what means that the data follow a normal distribution (Figure 20) and, in this case, the best test to be used is the Tukey test, to compare the differences between the treatments.
...
We can't see differences between the results of Ducan, Tukey and Kruskal test, in the differences between treatments (Figures 21, 22 and 23). The Shapiro-Wilk normality test was performed for Anova and Square Root Anova because in Anova p was higher than 0.05, what means that the data follow a normal distribution (Figure 24) and, in this case, the best test to be used is the Tukey test, to compare the differences between the treatments.
