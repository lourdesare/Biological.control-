...
The Duncan and Tukey tests did not have differences (Figures 9 and 10) and they had only few differences to the Kruskal test (Figure 11). The Shapiro-Wilk normality test was performed for Anova and Square Root Anova because in Anova p was lower than 0.05, that means that the data don't deviate from a normal distribution (Figure 12) and, in this case the best test to be use is a nonparametric test, like the Ducan or Kruskal, to compare the differences between the treatments.
