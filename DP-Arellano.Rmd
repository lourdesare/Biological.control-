...
Little differences were observed between Duncan and Tukey analyzes for *R. solani* colony growth at 3 and 5 days. However, there were no differences between both analyzes at 7 days (Figures 20 and 21). The treatments with the best antagonistic actitivy were both *B. velezensis* strains: BZR 517 and BZR 336g, in their medium and high concentrations: 10^5 CFU/mL and 10^6 CFU/mL, generating the lower colony growth after 7 days.

The Shapiro-Wilk normality test was performed for ANOVA, the p value was higher than 0.05, wich means that the data have a normal distribution (Figure XX).
>>>>>>> 884d13693fb1d972a47425d822ce498571a1d620
...
ggplot(plot.means, aes(x = Days,
  ...
  labs(title = "",
       ...
       color = "Trat") +
  theme_light()+
  labs(caption = "Figure 19. The influence of B. velezensis strains on the growth of R. solani in vitro") +
  theme(plot.caption.position = "plot",
        plot.caption = element_text(hjust = 0))
```
...
dl <- data.frame(
  l=c("a","b","bc","bc","bcd","cd","d","a","b","c","c","c","c","c","a","b","c","c","c","c","c"),
...
dlt <- data.frame(
  lt=c("a","b","b","bc","bc","bc","c","a","b","bc","c","c","c","c","a","b","b","c","c","c","c"),
  Days=c(3,3,3,3,3,3,3,5,5,5,5,5,5,5,7,7,7,7,7,7,7),
...
```
<font size="1"> Figure No. 22 Normality of Residuals for Antagonistic activity</font>
