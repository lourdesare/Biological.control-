...
**2. Open and Arrange Data:** For this sept, it was used the package "Readxl" to charge the excel file 
```{r include = FALSE}
library(readxl)
...
**3. Do analysis:**
Comparation between ANOVA and Duncan test in this three data sets. All results were expressed and analyzed as the mean. 
...
yield123 <- ggerrorplot(YieldOfPotato, x = "Cultivar", y = "Yield.Potato",
  ...
  facet_grid(.~Year)+
  theme_light()+
  labs(caption = "Figure No. 8 Yield of potato (t/ha)") +
  theme(plot.caption.position = "plot",
        plot.caption = element_text(hjust = 0))
#yield123
