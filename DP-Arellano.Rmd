...
The Shapiro-Wilk normality test was performed for ANOVA, the p values at 3, 5 and 7 days were less than alpha=0.05, which means that the data do not follow a normal distribution (Figure 22).
...
<font size="1"> Figure No. 23 Normality of Residuals for Antagonistic activity</font>
